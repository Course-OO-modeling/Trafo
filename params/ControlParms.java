...
public class ControlParms extends EllipsoidParms {
    ...
    private double sourceCoordinateX;  /**< Input coordinate X */
    private double sourceCoordinateY;  /**< Input coordinate Y */
    private double sourceCoordinateZ;  /**< Input coordinate Z */
    private String toprojection;
    private String todatum;
    private double toawert;
    private double tobwert;
    private boolean changedatum;   /**< True/False means with/without datum changement */
    private String northhem;    /**< Hemisphere */
    private String kindofhoehe;   /**< Height calculation */
    private String kindoftrafo;   /**< Kind of transformation (e.g. 3D similarity transformation) */
    private double dx;            /**< Translation X (For Molodenskii und 3D similarity transformation) */
    private double dy;            /**< Translation Y (For Molodenskii und 3D similarity transformation) */
    private double dz;			  /**< Translation Z (For Molodenskii und 3D similarity transformation) */
    private double da;            /**< Difference in large semi axis (For Molodenskii-Transformation) */
    private double df;            /**< Difference flattening (For Molodenskii-Transformation) */
    private double wx;            /**< Rotation X (For 3D similarity transformation) */
    private double wy;			  /**< Rotation Y (For 3D similarity transformation) */
    private double wz;			  /**< Rotation Z (For 3D similarity transformation) */
  
    private double Rz1;           /**< first Rotation about current Z  (For Eulerstransformation) */
    private double Rx2;			  /**< second Rotation about current X (For Eulerstransformation) */
    private double Rz3;			  /**< third Rotation about current Z  (For Eulerstransformation) */
    
    private double massstab;     /**< Scale (For 3D similarity transformation) */
    private double destinationCoordinateX; /**< Currently not used */
    private double destinationCoordinateY; /**< Currently not used */
    private double destinationCoordinateZ; /**< Currently not used */
    ...
    private static ControlParms instance = null;    /**< Singleton */
...
******************************************************************************************************************/
    ...
    /**
     * @brief getter method that returns point number of the particular Coordinate point
     * @return point_number - returns the point number of the particular Coordinate point as long value
     */
    ...
    /**
     * @brief setter method that accepts point number for the particular Coordinate point
     * @param point_number - a long value representing the point number for the particular Coordinate point
     */
