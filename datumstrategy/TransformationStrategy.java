 ...
 *  the concrete transformation algorithms that are implemented by the child classes of TransformationStrategy 
 *  implement the abstract method {@link #transform(GeographicCoordinateInterface) 
 *  transform(GeographicCoordinateInterface)} that performs the transformation with geographic coordinates 
 *  as input/output   
 ...
 *  @remark last refactored 21.01.2019 by Norbert Rösch (now only object of GeographicCoordinateInterface
 *  are allowed to communicate with the different strategies
 *  <ul>
