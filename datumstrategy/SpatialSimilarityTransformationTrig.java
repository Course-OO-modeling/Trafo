...
public class SpatialSimilarityTransformationTrig extends TransformationStrategy {
    ...
    public void transform(GeographicCoordinateInterface geo) {
    	...
    	double[][] anglesOfRotation = {{Math.cos(control.getWy())*Math.cos(control.getWz()), Math.cos(control.getWx())*Math.sin(control.getWz())+Math.sin(control.getWx())*Math.sin(control.getWy())*Math.cos(control.getWz()), Math.sin(control.getWx())*Math.sin(control.getWz())-Math.cos(control.getWx())*Math.sin(control.getWy())*Math.cos(control.getWz())},{-Math.cos(control.getWy())*Math.sin(control.getWz()), Math.cos(control.getWx())*Math.cos(control.getWz())-Math.sin(control.getWx())*Math.sin(control.getWy())*Math.sin(control.getWz()), Math.sin(control.getWy())*Math.cos(control.getWz())+Math.cos(control.getWx())*Math.sin(control.getWy())*Math.sin(control.getWz())},{Math.sin(control.getWy()), -Math.sin(control.getWx())*Math.cos(control.getWy()), Math.cos(control.getWx())*Math.cos(control.getWy())}};
