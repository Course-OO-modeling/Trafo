 ...
 * Needed parameter for the EulersTransformation: 3 translation-, 1 scale- and 3 rotation -parameters.
 ...
 * The Translation is done with cartesian coordinates and the rotation is implemented with trigonometric function. 
 ...
 * 
 * source of EulersTransformation: https://en.wikipedia.org/wiki/Euler_angles
 * @author Yucheng Luo
...
public class EulersTransformation extends TransformationStrategy {
	 ...
	 * Rotation : rotate with principle of conventional Euler's Standard-x-convention (Rz1,Rx2,Rz3).
     * Algorithm explanation : Rotate first about Z-axis ,after first step rotate about current X-axis, at end rotate about current Z-axis.
     * Link to the Algorithm : https://de.wikipedia.org/wiki/Eulersche_Winkel
     * 
     * @author Yucheng Luo
	 */
	@Override
    public void transform(GeographicCoordinateInterface geo) {
    	...
    	e2 = -Math.cos(control.getRz1())*Math.sin(control.getRz3())-Math.sin(control.getRz1())*Math.cos(control.getRx2())*Math.cos(control.getRz3());
    	e3 =  Math.sin(control.getRz1() )*Math.sin(control.getRx2());
    	e4 =  Math.sin(control.getRz1())*Math.cos(control.getRz3())+Math.cos(control.getRz1())*Math.cos(control.getRx2())*Math.sin(control.getRz3());
    	e5 = -Math.sin(control.getRz1())*Math.sin(control.getRz3())+ Math.cos(control.getRz1())*Math.cos(control.getRx2())*Math.cos(control.getRz3()) ;
