 ...
 * @remark 2016-12-04 added new method calculateRotationMatrix(SpatialSimilarityTransformParm) by David Li
...
******************************************************************************************************************/
 ...
 /**
	 ...
	 * @remark parameters changed to x-, y- and zAxis (were too inexpressive x1, x2 and x3) by unknown
	 * @remark 2018-01-25 renamed parameters to xValue, yValue, zValue (were xAxis, yAxis, zAxis before) by Markus Müller
...
******************************************************************************************************************/
	...
	/**
     * @brief Function for transforming geocentric coordinates to geographic coordinates
     * @brief Implemented by Michael Loos on 16.06.1998, based on a FORTRAN-Subroutine from 12.08.1993 by Hansjoerg Kutterer
     * @brief <p> => Needs the function 'Constant' from LatParm.java! </p>
     * @author Michael Loos
     ...
     * @return geo - returns geographic coordinate consisting of the double values latitude, longitude and ellipsoidal height
     */
    @Override
    ...
    /**
     * @brief Function for transforming geographic coordinates to geocentric coordinates
     * @author Michael Loos, 1998-06-06 as of a FORTRAN-Subroutine from Hansjoerg Kutterer, 1993-08-12
     * @remark formal changes in Summer 2000 by Daniel Mueller
     * @remark Java-Version in February 2003 by Norbert Roesch
     * @brief Algorithm as of G. Schmitt, M. Illner and R. Jaeger, "Transformationsprobleme",
     * pp. 125-142 in Mitteilungen des DVW Landesvereins BaWue, Sonderheft "GPS und Integration
     * von GPS in bestehende geodaetische Netze", 1991.
     * @param ell - an object of type EllipsoidParms that represents ellipsoidal parameters
    ...
    ******************************************************************************************************************/
        ...
        /**
         * @brief getter method that returns the x-coordinate of the particular XYZCoordinate
         * @return x - returns the x-coordinate value of the particular Coordinate point as double
         */
        public double getX() {
            return x;
        }
        ...
        /**
         * @brief setter method that accepts x-coordinate for the particular XYZCoordinate
         * @param x - sets a double representing the x-coordinate value for the particular XYZCoordinate
         */
        ...
        /**
         * @brief getter method that returns the y-coordinate of the particular XYZCoordinate
         * @return y - returns the y-coordinate value of the particular Coordinate point as double
         */
        public double getY() {
            return y;
        }
        ...
        /**
         * @brief setter method that accepts y-coordinate for the particular XYZCoordinate
         * @param y - sets a double representing the y-coordinate value for the particular XYZCoordinate
         */
        ...
        /**
         * @brief getter method that returns the z-coordinate of the particular XYZCoordinate
         * @return z - returns the z-coordinate value of the particular Coordinate point as double
         */
        public double getZ() {
            return z;
        }
        ...
        /**
         * @brief setter method that accepts z-coordinate for the particular XYZCoordinate
         * @param z - sets a double representing the z-coordinate value for the particular XYZCoordinate
         */
