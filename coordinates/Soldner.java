...
public class Soldner extends Coordinate {
	...
	/**
	 * < Height above ellipsoid: 0 => no height (not defined), 1 => ellispsoidal, 2
	 * => geoid
	 */
	...
	/**
	 * @brief prints Soldner coordinates with reference longitude, -latitude,
	 *        abscissa, ordinate and height
	 */
	public void print() {
	...
	/**
	 * @brief fromGeographic calculates Soldner coordinate from geographic
	 *        coordinate
	 * @param ell      - the ellipsoidal parameters as an instance of EllipsoidParms
	 * @param geocoord - a geographic coordinate as an instance of
	...
	/**
	 * @brief getter method that returns the reference latitude of the particular
	 *        Soldner coordinate
	 * @return l0 - returns the reference latitude of the particular Soldner
	...
	/**
	 * @brief setter method that accepts the reference latitude of the particular
	 *        Soldner coordinate
	 * @param l0 - sets a double representing the reference latitude of the
	 *           particular Soldner coordinate
	 */
	...
	/**
	 * @brief getter method that returns the reference longitude of the particular
	 *        Soldner coordinate
	 * @return b0 - returns the reference longitude of the particular Soldner
	 *         coordinate as double
	 */
	public double getB0() {
		return b0;
	...
	/**
	 * @brief setter method that accepts the reference longitude of the particular
	 *        Soldner coordinate
	 * @param b0 - sets a double representing the reference longitude of the
	 *           particular Soldner coordinate
	 */
	...
	/**
	 * @brief getter method that returns the abscissa of the particular Soldner
	 *        coordinate
	 * @return abszisse - returns the abscissa of the particular Soldner coordinate
	 *         as double
	 */
	...
	/**
	 * @brief setter method that accepts the abscissa of the particular Soldner
	 *        coordinate
	 * @param abszisse - sets a double representing the abscissa of the particular
	 *                 Soldner coordinate
	 */
	...
	/**
	 * @brief getter method that returns the ordinate of the particular Soldner
	 *        coordinate
	 * @return ordinate - returns the ordinate of the particular Soldner coordinate
	 *         as double
	 */
	...
	/**
	 * @brief setter method that accepts the ordinate of the particular Soldner
	 *        coordinate
	 * @param ordinate - sets a double representing the ordinate of the particular
	 *                 Soldner coordinate
	 */
	...
	/**
	 * @brief getter method that returns the height of the particular Soldner
	 *        coordinate
	 * @return height - returns the height of the particular Soldner coordinate as
	 *         double
	 */
	...
	/**
	 * @brief setter method that accepts the height of the particular Soldner
	 *        coordinate
	 * @param height - sets a double representing the height of the particular
	 *               Soldner coordinate
	 */
	...
	/**
	 * @brief getter method that returns the ellipsoidal of the particular Soldner
	 *        coordinate
	 * @return ellipsoidal - returns the ellipsoidal of the particular Soldner
	...
	/**
	 * @brief setter method that accepts the height above ellipsoid of the
	 *        particular Soldner coordinate
	 * @param ellipsoidal - sets a integer representing the height above ellipsoid
	 *                    of the particular Soldner coordinate
	 */
