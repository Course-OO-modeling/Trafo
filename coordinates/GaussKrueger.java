...
public class GaussKrueger extends Gauss {
	...
	/**
	 * < 'rechts' is the official term used by the German survey admistration
	 * ('easting')
	 */
	private double hoch;
	/**
	 * < 'hoch' is the official term used by the German survey admistration
	 * ('northing')
	 */
	private int centralMeridian;
	...
	/**
	 * @brief prints a string representation of the Gauss-Krueger object into the
	 *        console
	 */
	public void print() {
	...
	// To be implemented and extract the calculation method from
	...
	/**
	 * @brief getter method that returns the the northing of the particular
	 *        GaussKrueger instance
	 * @return rechts - returns the northing of the particular GaussKrueger instance
	 *         as double
	 */
	...
	/**
	 * @brief setter method that accepts the easting of the particular GaussKrueger
	 *        instance
	 * @param rechts - sets a double representing the easting for the particular
	 *               GaussKrueger instance
	 */
	 ...
	 * @return hoch - returns the northing of the current GaussKrueger instance as
	 *         double
	 */
	...
	/**
	 * @brief setter method that accepts the northing of the particular GaussKrueger
	 *        instance
	 * @param hoch - sets a double representing the northing for the particular
	 *             GaussKrueger instance
	 */
	...
	/**
	 * @brief getter method for the reference meridian of the current GaussKrueger
	 *        instance
	 * @return centralMeridian - returns the reference meridian of the current
	 *         GaussKrueger instance as integer
	 */
	public int getIlao() {
	...
	/**
	 * @brief setter method for the number of the reference meridian of the current
	 *        GaussKrueger instance
	 * @param ilao - sets an integer as the number of the reference meridian of the
	 *             current GaussKrueger instance
	 */
