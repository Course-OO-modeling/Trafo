 ...
 *         Stoetzer
 * @remark 2018-01-25 added XYZ-Coordinate to getCoord by Markus M�ller
 * @version 0.1
...
public class GetAppropriateCoordinate {
	/**
	 * @brief getter method that returns an appropriate coordinate depending on the
	 *        users input
